<!-- Rosh Hashana service times, as given by Marc 3 September 2026 and
relabeled to his layout of 7 September 2026.
Format: "# BIG — normal" headings (split at the em-dash), "Label = time | description"
rows ("Label =" with no time is a label-only row, e.g. BREAK), "* note"
paragraphs in place, and "---" for a William Morris separation bar. -->
# FIRST NIGHT — FRIDAY NIGHT
'ARBIT = 7:00 pm | Evening service
# FIRST DAY — SATURDAY MORNING
