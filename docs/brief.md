...
The weekly schedule moved from Thursday to Wednesday at Marc's direction (3 September 2026): proof 6:00 am Wednesday, reminder 5:00 pm, publish and send 6:00 pm Wednesday, late approval publishing immediately. The RSVP line gained "by Thursday night at 10:00 pm" the same day. Mailchimp campaigns carry a single address serving as both From and Reply-To, so the brief's separate Reply-To is impossible; instead shabbat@kzzhv.org forwards to the secretary's Gmail (as does contact@), and replies land with the secretary as intended.
